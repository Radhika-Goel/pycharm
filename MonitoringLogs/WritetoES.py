...
directory = '/Users/radhikagoel/Downloads/'
...
for filename in os.listdir(directory):
    if filename.endswith(".json"):
        filename = '/Users/radhikagoel/Downloads/' + filename
        f = open(filename)
        docket_content = f.read()
        es.index(index='order', doc_type='test', id=i,body=json.loads(json.dumps(docket_content)))
        i = i+1
